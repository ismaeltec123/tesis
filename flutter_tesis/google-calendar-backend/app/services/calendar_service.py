...
class GoogleCalendarService:
    ...
    def _convert_from_google_format(self, google_event: Dict[str, Any], preserve_type: str = None) -> Dict[str, Any]:
        ...
        # Usar el tipo preservado si se proporciona, sino marcar como importado
        event_type = preserve_type if preserve_type else 'importado'
